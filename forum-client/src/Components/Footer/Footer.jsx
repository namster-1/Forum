    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.brand}>
          ...
          <p className={styles.tagline}>A place for IT people to share ideas, ask questions and grow together.</p>
        </div>
        ...
        <div className={styles.links}>
          ...
          <div className={styles.linkGroup}>
            ...
            <Link to="/new-thread">Ask a Question</Link>
          </div>
      ...
      <div className={styles.bottom}>
        <span>© {new Date().getFullYear()} DevForum. All rights reserved.</span>
